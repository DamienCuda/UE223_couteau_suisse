    ...
    <body id="index_body">
        <main class="search_container">
            ...
            <form id="homepage_form" action="vue/templates/meteo.php" method="post">
                <fieldset class="autocomplete-container" id="index_autocomplete_container_city">
                    <label for="index_city_input" hidden="true"></label>
                    <input type="text" id="index_city_input" placeholder="Entrez une ville" autocomplete="off"/>
